...
from django.db.models import FloatField as DjangoFloatField, DecimalField as DjangoDecimalField  # Правильные импорты
...
class AdCampaignStatisticsView(LoginRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # Собираем статистику для каждой кампании
        statistics_data = []
        ...
        for campaign in campaigns:
            ...
            # Количество активных клиентов из этой кампании
            active_clients_count = Customer.objects.filter(
                contract__lead__campaign=campaign
            ).count()

            # Общий доход от контрактов
